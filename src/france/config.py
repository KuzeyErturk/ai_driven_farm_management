...
PATHS = {
    ...
    'ireland_processed': os.path.join(PROJECT_ROOT, 'data', 'ireland', 'processed'),
    'netherlands_processed': os.path.join(PROJECT_ROOT, 'data', 'netherlands', 'processed'),
    'belgium_processed': os.path.join(PROJECT_ROOT, 'data', 'belgium', 'processed'),
    'denmark_processed': os.path.join(PROJECT_ROOT, 'data', 'denmark', 'processed'),
