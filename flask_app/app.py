...
Uses crop-specific models and features from the dissertation research.
"""
...
# Load crop-specific model config (generated by train_improved_models.py)
MODEL_CONFIG = {}
...
def predict():
    ...
    try:
        ...
        # Get crop-specific feature list from config
        ...
        if crop in _models and crop in _scalers and feature_names:
